  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .gradient-overlay {
          background: linear-gradient(to right, rgba(10, 25, 70, 0.75) 0%, rgba(10, 25, 70, 0.60) 35%, rgba(10, 25, 70, 0.15) 60%, rgba(10, 25, 70, 0.0) 100%);
        }
        
        @media (max-width: 768px) {
          .gradient-overlay {
            background: linear-gradient(to bottom, rgba(10, 25, 70, 0.60) 0%, rgba(10, 25, 70, 0.30) 40%, rgba(10, 25, 70, 0.0) 100%);
          }
        }
      `}</style>
