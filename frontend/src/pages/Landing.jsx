...
const GoogleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ background: '#fff', borderRadius: '4px', padding: '2px' }}>
    ...
    <div style={{ margin: 0, padding: 0, fontFamily: "'Inter', -apple-system, sans-serif", backgroundColor: '#fdfcfa', minHeight: '100vh' }}>
      ...
      <div
        style={{
          ...
          backgroundImage: `linear-gradient(to right, #fdfcfa 35%, rgba(253, 252, 250, 0) 65%), linear-gradient(to bottom, rgba(253, 252, 250, 0) 60%, #fdfcfa 95%), url(${backgroundImage})`,
      ...
      <div style={{ height: '55vh', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <svg width="34" height="34" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="50" cy="50" r="45" stroke="#1e3a8a" strokeWidth="8" fill="none"/>
              <path d="M40 30H55C63.2843 30 70 36.7157 70 45C70 53.2843 63.2843 60 55 60H40V30Z" fill="#1e3a8a"/>
              <path d="M40 60V80" stroke="#1e3a8a" strokeWidth="8" strokeLinecap="round"/>
              <circle cx="55" cy="45" r="8" fill="#fff"/>
            </svg>
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
              <span style={{ fontWeight: 800, fontSize: 16, color: '#111827', letterSpacing: '0.5px' }}>POORNIMA</span>
              <span style={{ fontWeight: 600, fontSize: 12, color: '#2563eb' }}>UNIVERSITY</span>
            </div>
          </div>
          {/* Right Actions */}
        ...
        <div style={{
          ...
          <h1 style={{ margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
            <span style={{ fontSize: '38px', fontWeight: 800, color: '#1f2937', letterSpacing: '-0.5px' }}>Poornima University</span>
            <span style={{ fontSize: '42px', fontWeight: 800, color: '#1e3a8a', letterSpacing: '-0.5px' }}>Event Management Portal</span>
          </h1>
          <p style={{ margin: '4px 0 16px 0', fontSize: '16px', color: '#4b5563', fontWeight: 500 }}>
      ...
      <div style={{
        ...
        <div style={{ background: '#fdfcfa' }}>
          <div style={{ maxWidth: 1440, margin: '0 auto', padding: '24px 48px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1.6fr 1fr', gap: 16, marginBottom: 16 }}>
              ...
              <div style={card}>
                ...
                <div style={{ display: 'flex', gap: 16, alignItems: 'center', marginTop: 12 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <button onClick={scrollToRegister} style={applyBtn}>Apply Now →</button>
                  </div>
                </div>
              </div>
              ...
              <div style={card}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  {announcements.map((a, i) => (
                    <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: i < announcements.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <span style={{ width: 6, height: 6, borderRadius: '50%', background: a.color, display: 'inline-block' }} />
                        <span style={{ fontSize: 12, color: '#374151', fontWeight: 500 }}>{a.text}</span>
                      </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1.8fr 1.3fr 1fr', gap: 16, marginBottom: 16 }}>

              {/* About SIH 2026 */}
              <div style={card}>
                <div style={{ fontWeight: 700, fontSize: 14, color: '#1f2937', marginBottom: 12 }}>About SIH 2026</div>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 10 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#1f2937', lineHeight: 1.2 }}>{item.val}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* Timeline */}
              <div style={card}>
                <div style={{ fontWeight: 700, fontSize: 14, color: '#1f2937', marginBottom: 16 }}>Timeline</div>
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', position: 'relative', padding: '0 8px' }}>
                  <div style={{ position: 'absolute', top: 21, left: '8%', right: '8%', height: 1.5, background: '#e5e7eb', zIndex: 0 }} />
                  {timelineSteps.map((step, i) => (
                    <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 1, flex: 1 }}>
                      ...
                      <div style={{ fontSize: 10, fontWeight: 600, textAlign: 'center', color: '#374151', lineHeight: 1.3, whiteSpace: 'pre-line' }}>{step.label}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div id="team-registration" style={card}>
                <div style={{ fontWeight: 700, fontSize: 14, color: '#1f2937', marginBottom: 6 }}>Apply For Team Registration</div>
                <div style={{ fontSize: 12, color: '#6b7280', marginBottom: 16 }}>Apply for your team registration through Google Form</div>
                <a
              ...
              {/* Quick Links */}
              <div style={card}>
                <div style={{ fontWeight: 700, fontSize: 14, color: '#1f2937', marginBottom: 10 }}>Quick Links</div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '24px' }}>
              <a href="#" style={{ color: '#cbd5e1', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#fff'} onMouseLeave={(e) => e.target.style.color = '#cbd5e1'}>Privacy Policy</a>
              <a href="#" style={{ color: '#cbd5e1', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#fff'} onMouseLeave={(e) => e.target.style.color = '#cbd5e1'}>Terms & Conditions</a>
              <a href="#" style={{ color: '#cbd5e1', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.target.style.color = '#fff'} onMouseLeave={(e) => e.target.style.color = '#cbd5e1'}>Contact Us</a>
            </div>
